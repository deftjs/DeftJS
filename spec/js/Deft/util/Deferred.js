...
describe('Deft.util.Deferred', function() {
  describe('Registering callbacks via then()', function() {
    ...
    describe('with callbacks specified via method parameters, with omitted callbacks', function() {
      ...
      for (index = 0; index <= 3; index++) {
        _results.push(describe("omitting " + callbackNames[index] + " callback", function() {
    ...
    return describe('with callbacks specified via configuration Object, with omitted callbacks', function() {
      var callbackNames, createCallbacksFactoryFunction, index, thenFunction, _results;
      thenFunction = function(deferred, successCallback, failureCallback, progressCallback, cancelCallback) {
        return deferred.then({
          success: successCallback,
  ...
  return describe('Completion', function() {
    var cancelCallback, deferred, failureCallback, progressCallback, successCallback;
    deferred = null;
    successCallback = failureCallback = progressCallback = cancelCallback = null;
    beforeEach(function() {
    ...
    return it('should not allow cancellation after cancellation', function() {
      deferred.then(successCallback, failureCallback, progressCallback, cancelCallback);
      deferred.cancel('reason');
      if (cancelCallback != null) cancelCallback.reset();
      expect(function() {
